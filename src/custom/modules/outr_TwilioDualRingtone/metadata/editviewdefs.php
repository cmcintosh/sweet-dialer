<?php
/**
 * S-097: Dual Ringtone Edit View
 * Fields: Name, File, Category, Sub Category, Assigned To, Dates, Status
 */

$viewdefs['outr_TwilioDualRingtone']['EditView'] = array(
    'templateMeta' => array(
        'form' => array(
        ...
        'lbl_audio_file' => array(
            array(
                array(
                    ...
                    'label' => 'LBL_FILE',
                    'type' => 'file',
                    'comment' => 'Upload audio file for dual ringtone (mp3, wav)',
                ),
            ),
        ),
